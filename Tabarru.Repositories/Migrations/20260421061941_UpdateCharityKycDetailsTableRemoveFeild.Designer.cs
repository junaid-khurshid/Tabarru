...
namespace Tabarru.Repositories.Migrations
{
    ...
    [Migration("20260421061941_UpdateCharityKycDetailsTableRemoveFeild")]
    partial class UpdateCharityKycDetailsTableRemoveFeild
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tabarru.Repositories.Models.Campaign", b =>
                {
                    ...
                    b.Property<bool>("isMembershipForm")
                        .HasColumnType("bit");

                    b.Property<bool>("isStudentForm")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Tabarru.Repositories.Models.Charity", b =>
                {
                    ...
                    b.Property<string>("CharityPhoneNumber")
                        .IsRequired()
                        .HasMaxLength(200)
            ...
            modelBuilder.Entity("Tabarru.Repositories.Models.MembershipDetail", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("HouseNumberAndName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Tabarru.Repositories.Models.PasswordResetToken", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Tabarru.Repositories.Models.StudentFormDetail", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Tabarru.Repositories.Models.PasswordResetToken", b =>
                {
                    b.HasOne("Tabarru.Repositories.Models.Charity", "Charity")
                        .WithMany()
                        .HasForeignKey("CharityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
