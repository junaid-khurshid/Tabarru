...
namespace Tabarru.RequestModels
{
    ...
    public class CharityKycReSubmitRequest
    {
        [Required(ErrorMessage = "REQUIRED")]
        public string FirstName { get; set; }
        [Required(ErrorMessage = "REQUIRED")]
    ...
    static class CharityKycResubmitExtension
    {
        public static CharityKycDto MapToDto(this CharityKycReSubmitRequest request)
        {
            return new CharityKycDto
            {
                BankStatement = request.BankStatement,
